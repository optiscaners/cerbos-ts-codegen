import type { Principal, IsAllowedRequest } from "@cerbos/core/lib/types/external";
...
declare module "@cerbos/http" {
    ...
    type isAllowedParams = IsAllowedRequest & (
             isAllowedParamsBusinessPartner | isAllowedParamsFleet | isAllowedParamsUiMenu | isAllowedParamsVdpCheck | isAllowedParamsVehicle);
}
